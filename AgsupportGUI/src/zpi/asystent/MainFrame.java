...
public class MainFrame extends JFrame implements Observer {
	...
	private final String lblSMAcap = "Średnia krokowa prosta";
	private final String lblWMAcap = "Średnia krokowa ważona";
	private final String lblEMAcap = "Średnia krokowa wykladnicza";
	...
	public MainFrame(final ControllerInterface controller) {
		...
		JMenu mnNewMenu_widok = new JMenu("Wskaźniki");
